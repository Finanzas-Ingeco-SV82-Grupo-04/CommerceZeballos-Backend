package com.example.commercezeballos.security_management.domain.jwt.utils;
...
public class JwtUtils  {
    ...
    //aca vamos a agregar el metodo para obtener el id del usuario y meterlo en el token
}
